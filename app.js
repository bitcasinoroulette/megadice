...
var config = {
  ...
  app_name: 'BitCasino.ML',
  // - For your faucet to work, you must register your site at Recaptcha
  // - https://www.google.com/recaptcha/intro/index.html
  recaptcha_sitekey: 'gCaptcha',  // <----- EDIT ME!
  redirect_uri: 'http://bitcasino.ml',   // <----- EDIT ME!
  mp_browser_uri: 'https://www.moneypot.com',
  mp_api_uri: 'https://api.moneypot.com',
  chat_uri: '//socket.moneypot.com',
  check_jackpot: '//diceco.in/api/check.php?jackpot=',  // <----- EDIT ME!
  jackpot_increase: '//diceco.in/api/jackpot.php?bet_id=',  // <----- EDIT ME!
  history_jackpots: '//diceco.in/api/jackpots_history.php?jackpot=',  // <----- EDIT ME!
    tip_command:'$tip',
    ...
    house_edge: 0.02,                                    // <----- EDIT ME!
    chat_buffer_size: 250,                 // <----- EDIT ME!
    // - The amount of bets to show on screen in each tab
    bet_buffer_size: 25                     // <----- EDIT ME!
...
var jacpot_sound = new Audio("http://bitcasino.ml/sounds/jackpot.mp3");       // <----- EDIT ME!
var jacpot_voice = new Audio("http://bitcasino.ml/sounds/jackpot_voice.mp3"); // <----- EDIT ME!
